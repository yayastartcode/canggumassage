...
export function Footer() {
  const services = [
    { name: 'Insect Control (Serangga)', icon: Bug },
    { name: 'Rodent Control (Tikus)', icon: Rat },
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 mb-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-slate-400 leading-relaxed mb-4">
              Solusi profesional untuk pengendalian hama dan layanan cleaning service di Bandung. Kami berkomitmen memberikan layanan terbaik untuk kenyamanan Anda.
            </p>
          </div>
        ...
        <div className="border-t border-slate-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-slate-400 text-sm">
              © {currentYear} Jagahama. All rights reserved.
            </p>
